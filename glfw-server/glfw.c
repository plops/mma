...
struct{ 
  ...
  char docstring[DOCSTRINGLEN];
	...
	{"qgrating-disk",6,1,qgrating_disk,"draw a grating disk x y r phase phases width"},
	{"grating-disk",6,0,grating_disk,"immediately draw a grating disk cx cy r phase phases width"},
